...
import type { GL } from './RevenueYearComparisonChart';
import { buildApiUrl } from '../../utils/api';



import { Button, ButtonGroup } from '@mui/material';
const RevenueYearComparisonChart = require('./RevenueYearComparisonChart').default;
  ...
  return (
    ...
    >
      <Box sx={{ width: '100%', height: '90%' }}>
        ...
        <RevenueYearComparisonChart currentYearData={currentYearData} prevYearData={prevYearData} selectedYear={currentYear} />
      </Box>
    </Box>
  );
};

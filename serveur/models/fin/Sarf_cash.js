...
// Model maps to table: Sarf_cash
const SarfCash = sequelize.define(
  "Sarf_cash",
  {
    ID_transaction: {
    ...
    NUM_CHECK: { type: DataTypes.STRING(50), allowNull: true },
    ...
    id_requisition_item_system: { type: DataTypes.INTEGER, allowNull: true },
  },
  {
...
module.exports = sequelize.model("Sarf_cash", SarfCash);
